...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Omnifood is a premium food deliver service with the mission to bring affordable and healthy meals to as many people as possible.">
    ...
    <link rel="mask-icon" href="resources/favicons/safari-pinned-tab.svg" color="#282b2b">
  ...
  <body>
    ...
    <section class="section-steps" id="works">
      ...
      <div class="row">
        ...
        <div class="col span-1-of-2 steps-box clearfix">
            ...
            <form class="contact-form" action="mailer.php" method="post">
              ...
              <div class="row">
                ...
                <div class="col span-2-of-3">
                  <input id="name" type="text" name="name" value="name" placeholder="Your Name" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col span-2-of-3">
                  <input id="email" type="email" name="email" value="email" placeholder="Your Email" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col span-2-of-3">
                  <select class="find-us" name="find-us">
    ...
    <footer class="clearfix">
      ...
      <div class="row">
        <p>&copy; 2015 by Omnifood. All rights reserved.</p>
      </div>
